...
(defn en
  []
  [:div.container.about
   [:h1.title "Wadi AlBuhair - a valley that awaits a small victory"]
   ...
   [:p [:a {:href "https://www.instagram.com/explore/tags/savewadialbuhair/"} [:i "- #SaveWadiAlBuhair"]]]
...
(defn ar
  ...
  [:div.container.about  {:dir "rtl" :lang "ar" :style {:font-size "125%"}}
   [:h1.title "وادي البحير — ينتظر ل'ينتصر' رغم كثرة أنصاره"]
   [:button.button.is-clickable.is-rounded.is-info.is-light
...
وادي البحير الذي يعد الوادي الوحيد المتبقي من وديان البحرين لا يزال شامخاً بحجارته الجيرية الدولوميتية والأحافير والمارل وصخوره الطينية وطبقات الطباشير وغيرها التي تقدم لنا نافذة  إلى عالم الجيولوجيا الطبيعية الرائعة في البحرين. هذه قصة وادي البحير الذي "
    [:a {:href "https://albiladpress.com/news/2022/4953/bahrain/756704.html"} "ينتظر ل'ينتصر'"] " رغم " [:a {:href "http://www.alwasatnews.com/news/415700.html"} "كثرة أنصاره."]]
   [:span.level
    [image "/img/buhair/geology1.jpg"]
    [image "/img/buhair/geology2.jpg"]]
   [:span.level
...
[:a {:href "https://alwatannews.net/Bahrain/article/915655/%D8%A8%D9%84%D8%AF%D9%8A-%D8%A7%D9%84%D8%AC%D9%86%D9%88%D8%A8%D9%8A%D8%A9-%D8%A5%D9%86%D8%B4%D8%A7%D8%A1-%D9%85%D9%86%D8%AA%D8%B2%D9%87-%D9%81%D9%8A-%D9%88%D8%A7%D8%AF%D9%8A-%D8%A7%D9%84%D8%A8%D8%AD%D9%8A%D8%B1"}
]"الموافقة على مقترح إعادة تأهيل وادي البحير إلى محمية طبيعية"
...
[:a {:href "https://www.gdnonline.com/Details/940595/Buhair-plan-withdrawn"}
]"سحب المقترح وموافقة الجهات المختصة على مشروع وحدات سكنية وتجارية"
" بعد ذلك. بدأت عمليات الردم والحفر بسرعة حتى باتت  تشمل أجزاء كبيرة من الوادي."]
   [image "/img/buhair/overview-flipped.png" "صورة جوية لوادي البحير - اليسار: اكتوبر ٢٠٢١، اليمين: مارس ٢٠٢٢" "صورة جوية لوادي البحير - اليسار: اكتوبر ٢٠٢١، اليمين: مارس ٢٠٢٢"]
...
[:a {:href "https://alwatannews.net/article/130636/%D9%87%D9%84-%D9%88%D8%A7%D8%AF%D9%8A-%D8%A7%D9%84%D8%A8%D8%AD%D9%8A%D8%B1-%D9%85%D8%AD%D9%85%D9%8A%D8%A9-%D8%B7%D8%A8%D9%8A%D8%B9%D9%8A%D8%A9!"} "بينته الدراسات البيئية"]
" السابقة بمخاطر تتعلق بالسلامة والصحة العامة منها "
[:a {:href "http://www.alwasatnews.com/news/547170.html"} "تسرب غاز الميثان"]
" الموجود في الوادي بسبب استعماله سابقاً كمكب للنفايات. لو كان هناك ثمن للحفاظ على البيئة فهناك ايضاً ثمن باهظ لعدم المحافظة عليها. "]
   ...
   [:span.level
    [image "/img/buhair/4.jpg" "" ""]
    [image "/img/buhair/6.jpg" "" ""]]
   [:p "يحتاج المرء أن يستنشق الهواء الطلق كما يحتاج للمسكن. وهذه الحقيقة واضحة للعيان عندما نرى الأعداد الهائلة من المواطنين والمقيمين الذين يتوجهون للمتنفسات العامة القليلة المتبقية في السواحل والبر والحزام الأخضر. أما ما تبقى من الطبيعة فهو محاط بالأسوار العالية. الطبيعة في البحرين يجب أن تكون للملك العام، لكافة الناس بصرف النظر عن قدراتهم المادية وخلفياتهم الاجتماعية."]
   ...
   [:p [:a {:href "https://www.instagram.com/explore/tags/%D8%A7%D9%86%D9%82%D8%B0%D9%88%D8%A7_%D9%88%D8%A7%D8%AF%D9%8A_%D8%A7%D9%84%D8%A8%D8%AD%D9%8A%D8%B1/"} [:i "- #انقذوا ـ وادي ـ البحير"]]]
   [image "/img/buhair/10.jpg" "" ""]
   [:span.level
    [image "/img/buhair/11.jpg" "" ""]
    [image "/img/buhair/8.jpg" "" ""]]
