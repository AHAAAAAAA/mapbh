...
(defn en []
  [:div.container.contribute
   ...
   [:p "Special thanks to Abrar Hasan and Mohamed Toorani for their help in sourcing and cataloging these maps, Majd Al-Shihabi, Maryam Zainal, and Ali Al-Jamri for sharing valuable insights, and everyone else that put up with me talking about maps and street intersections way too much."]])
...
(defn ar []
  [:div.container.contribute {:dir "rtl" :lang "ar" :style {:font-size "125%"}}
   ...
   [:ul {:style {:margin "2% 12%"}}
    ...
    [:li "• ترجمة إسقاطات خرائطية قديمة إلى إسقاط ميركاتور الحديث (web mercator)"]
   ...
   [:p "شكرٌ خاص الى أبرار حسن و محمد توراني على مساهمتهما في جمع و فهرسة الخرائط كما اتقدم بالشكر الحار لكل من مجد الشهابي و مريم زينل وعلي الجمري لما قدموه من رؤى قيّمة لإنجاز هذا المشروع والى كل من تحملني اثناء العام الماضي. "]])
