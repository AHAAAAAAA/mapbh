...
(defn en []
  [:div.container.about
   ...
   [:p
    {}
    "Today, you only need to walk ten minutes in any direction from the city centre today to witness the city roads transform from an organic web of collapsing histories into a regimented grid segmenting homes, businesses, and parks into neatly ordered zoning categories. While a wandering guest might take a moment to notice this sudden change in scenery from the street-level, old and new Manama are vividly distinguishable from space without a single label or place-mark. The old meandering alleys and roads, densely built around the different historic loci of power and trade, clash dramatically against a wall of ordered intersections and uniform rows of eight identical houses, each with a car garage, stretching out over many identical blocks. The how’s and why’s of Bahrain’s puzzling development in the post-independence era might seem inexplicable but it is carefully tucked in the margins of the aerial photos taken by the pilots tasked with surveying Bahrain in the mid-seventies. It’s only when you soar high above the city that you begin to glean an idea of how this story could have unfolded. From a pilot’s birds-eye view, traveling on a uniform surveying path along an imagined grid, one can imagine a grid around an ancient city and through the green belt cradling it. Yes, one can even draw a grid of intersections and eight-a-row houses over a green-blue seabed. From five hundred feet above ground, you’re almost forgiven for not noticing the creatures living in the natural divisions of city, meadow, and sea. On such a map, you could design a grid where only a single creature could freely roam with four wheels and a black cough. There are people today who will proudly proclaim that this, too, was the only manner in which Bahrain could’ve possibly developed. Yet, fifty years ago this trajectory was still only the subject of debate and conjecture."]
   ...
   [:p
    ...
    [:a
     {:href "https://www.faireysurveys.co.uk/category/personnel/page/2/"}
     "faireysurveys.co.uk"]
    ". Most of the "
    [:a
   ...
   [:p
    {}
    "Developments in distributed crowd-sourcing on the internet wrested control away from professional and governmental bodies that previously held a stranglehold on the creation and distribution of this information. These developments coincided with an era of modernisation in the ministries where the original Fairey Surveys were translated into MicroStation CAD files for use in Bahrain’s governmental bodies which could be updated plot-by-plot more regularly and asynchronously by different ministry bodies. While there likely remains no more editions of these Fairey Surveys series produced today, a cursory look at the topographic CAD maps used by the ministry shows familiar traces of the initial surveys from 1977 still alive in-between every alley, plot, and tree digitised. This modernisation period also represents the end of our insight into modern map-making in the Bahraini state as data is not publicly available past this point."]
   [:p
    {}
   ...
   [:p
    {}
    "When we started mapBH as a project 3 years ago, we were primarily focused on geo-referencing colonial maps being surfaced from the British national archives via the "
