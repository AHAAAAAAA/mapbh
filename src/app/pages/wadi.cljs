...
وادي البحير الذي يعد الوادي الوحيد المتبقي من وديان البحرين لا يزال شامخاً بحجارته الجيرية الدولوميتية والأحافير والمارل وصخوره الطينية وطبقات الطباشير وغيرها التي تقدم لنا نافذة  إلى عالم الجيولوجيا الطبيعية الرائعة في البحرين. هذه قصة وادي البحير الذي "
   ...
   [:span.level
    [image "/img/buhair/4.jpg" "" ""]
    [image "/img/buhair/6.jpg" "" ""]]
   [:p "يحتاج المرء أن يستنشق الهواء الطلق كما يحتاج للمسكن. وهذه الحقيقة واضحة للعيان عندما نرى الأعداد الهائلة من المواطنين والمقيمين الذين يتوجهون للمتنفسات العامة القليلة المتبقية في السواحل والبر والحزام الأخضر. أما ما تبقى من الطبيعة فهو محاط بالجدران العالية والحراس وتذاكر الدخول الباهظة. حق المواطن للأستمتاع بالسواحل والطبيعة من دون اي عوائق هو حق يمتد اليوم من سواحل البهامس الى مزارع بيلروس ويمتد حتى لعصر البيزنطيين، فلا يحق لأي فندق أو جهة خاصة احتكار المنافذ الطبيعية. الطبيعة في البحرين يجب أن تكون للملك العام، لكافة الناس بصرف النظر عن قدراتهم المادية وخلفياتهم الاجتماعية."]
