...
(defn en
  ...
  [:div.container.about
   ...
   [:span.level
    [image "/img/posts/buhair/geology1.jpg"]
    [image "/img/posts/buhair/geology2.jpg"]]
   [:span.level
    [image "/img/posts/buhair/FOUR-MF.jpeg" "Credit: Mohammed Al Farsi" "Credit: Mohammed Al Farsi"]]
   ...
   [image "/img/posts/buhair/overview-flipped.png" "Satellite imagery of Wadi AlBuhair. Left - June 2010, Middle - October 2021, Right - March 2022" "Satellite imagery of Wadi AlBuhair. Left - June 2010, Middle - October 2021, Right - March 2022"]
   ...
   [image "/img/posts/buhair/10.jpg" "" ""]
   [image "/img/posts/buhair/areas-to-save.jpg" "Areas that can still be saved" "Areas that can still be saved"]
   [:span.level
    [image "/img/posts/buhair/11.jpg" "" ""]
    [image "/img/posts/buhair/8.jpg" "" ""]]
   [:span.level
    [image "/img/posts/buhair/9.jpg" "" ""]
    [image "/img/posts/buhair/7.jpg" "" ""]]
   [image "/img/posts/buhair/THREE-MF.jpeg" "Credit: Mohammed Al Farsi" "Credit: Mohammed Al Farsi"]])
...
وادي البحير الذي يعد الوادي الوحيد المتبقي من وديان البحرين لا يزال شامخاً بحجارته الجيرية الدولوميتية والأحافير والمارل وصخوره الطينية وطبقات الطباشير وغيرها التي تقدم لنا نافذة  إلى عالم الجيولوجيا الطبيعية الرائعة في البحرين. هذه قصة وادي البحير الذي "
   ...
   [:span.level
    ...
    [image "/img/posts/buhair/geology2.jpg"]]
   [:span.level
    [image "/img/posts/buhair/FOUR-MF.jpeg"  "المصدر: محمد الفارسي" "المصدر: محمد الفارسي"]]
   ...
   [image "/img/posts/buhair/overview-flipped.png" "صورـ جوية لوادي البحير، اليسار - يونيو ٢٠١٠، النص: اكتوبر ٢٠٢١، اليمين: مارس ٢٠٢٢" "صور جوية لوادي البحير، اليسار - يونيو ٢٠١٠، النص: اكتوبر ٢٠٢١، اليمين: مارس ٢٠٢٢"]
   ...
   [:p "قد لا نستطيع تغيير الماضي لكننا نملك القدرة والإرادة لاختيار المستقبل الذي نريد، وأن نقف وقفة حازمة لحماية ما تبقى من بيئتنا للأجيال القادمة."]
   [:p "— مجموعة من مناصري البيئة في البحرين"]
   [:p
   ...
   [image "/img/posts/buhair/10.jpg" "" ""]
   [image "/img/posts/buhair/areas-to-save.jpg" "مناطق يجب الحفاظ عليها" "مناطق يجب الحفاظ عليها"]
   [:span.level
    [image "/img/posts/buhair/11.jpg" "" ""]
    [image "/img/posts/buhair/8.jpg" "" ""]]
   [:span.level
